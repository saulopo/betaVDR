function Tz = betaVDR(Trans_data,dx,dy,beta,dz)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Fourth-order beta-VDR method to compute the
% vertical derivative
%
...
UC5=real(UCinv);
%
coef=[2*beta^3 + 15*beta^2 + 35*beta + 25
 - 8*beta^3 - 54*beta^2 - 104*beta - 48
  12*beta^3 + 72*beta^2 + 114*beta + 36
  - 8*beta^3 - 42*beta^2 - 56*beta - 16
  2*beta^3 + 9*beta^2 + 11*beta + 3];
